...
export default async function getPostText() 
{
	...
	var awaitTweet = await mastodon.getStatuses("109747494700715321", {'limit':limitVal}); //Use the Mastodon API to get a specified number of recent posts from the Mastodon API.
